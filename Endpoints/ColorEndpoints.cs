...
public static class ColorEndpoints
{
    ...
    /// </summary>
    public static async Task<IResult> HandleRalMatch(int r, int g, int b, string? culture, IRalColorLoader colorLoader)
    {
    ...
    /// </summary>
    public static async Task<IResult> HandleColorSearch(string? q, string? culture, IRalColorLoader colorLoader)
    {
